...
/**
 * RegisterPage component handles onboarding new user registrations.
 * Contains input forms for full name, email, password, and confirm password,
 * plus show/hide toggles for both passwords, social buttons, and navigation links.
 *
 * @returns React.ReactElement containing the full-screen centered register container.
 */
export default function RegisterPage(): React.ReactElement {
  ...
  // Toggles for password fields visibility
